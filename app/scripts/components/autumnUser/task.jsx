...
const Task = React.createClass({
                    ...
                    <td>{
                      ...
                      <td>{item.job_title}</td>
                        <td>
                            ...
                            &nbsp;
                            <a href={item.help_file?`autumn/basic/jobfiles${item.help_file}`:'javascript:;'}
                               target="_blank"
  ...
  showDetail: function(id) {
    this.filterData(this.state.tableList, id, (showList) => {
      this.setState({
        ...
        imgUri:`autumn/basic/jobfiles/jobs/${ showList[0] }`
      });
    });
  },
  ...
  renderUrl: function(uri) {
    this.setState({
      imgUri: `autumn/basic/jobfiles/jobs/${ uri }`
    });
  },
