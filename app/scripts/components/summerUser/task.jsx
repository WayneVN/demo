...
const Task = React.createClass({
  ...
  getQuestions: function () {
    ...
    SpringModel.jobQuestions(uid, this.props.params.courseId, result => {
      const {
        status,
        data = []
      } = result;
                    ...
                    <td>{
                      ...
                      <td>{item.job_title}</td>
                        <td>
                            ...
                            &nbsp;
                            <a href={item.help_file?`camp/jobfiles/${this.props.params.courseId}${item.help_file}`:'javascript:;'}
                               target="_blank"
  ...
  showDetail: function(id) {
    this.filterData(this.state.tableList, id, (showList) => {
      this.setState({
        ...
        imgUri:`camp/jobfiles/${this.props.params.courseId}/jobs/${ showList[0] }`
      });
    });
  },
  ...
  renderUrl: function(uri) {
    this.setState({
      imgUri: `camp/jobfiles/${this.props.params.courseId}/jobs/${ uri }`
    });
  },
