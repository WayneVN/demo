            ...
            <ul className="nav-menu">
              <If when={isAdmin}>
                <li className="pure-menu-selected">
                  <Link to='/autumnproadmin/taskList' activeClassName="activeLink" >
              ...
              <If when={isAdmin}>
                <li className="pure-menu-selected">
                  <Link to='/autumnproadmin/answerlist' activeClassName="activeLink" >
              ...
              <If when={isAdmin}>
                <li className="pure-menu-selected">
                  <Link to='/autumnproadmin/userlist' activeClassName="activeLink" >
