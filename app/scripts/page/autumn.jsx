...
const AutumnPage = React.createClass({
  ...
  componentDidMount: function() {
    ...
    this.getData();
    logger.log({
      target: 'camp.class.index.autumn2016',
      data: {
        class: ''
      }
    });
          ...
          <aside className="tally-nav">
            <ul className="nav-menu">
                <li className="pure-menu-selected">
                  <Link to='/autumn/account' activeClassName="activeLink" >
                    <i className="fa fa-user" />我的帐户
                  </Link>
                </li>
                <li className="pure-menu-selected">
                  <Link to='/autumn/task' activeClassName="activeLink" >
                    <i className="fa fa-tasks" />每期作业
                  </Link>
                </li>
              <If when={isAnswer}>
                <li className="pure-menu-selected">
                  <Link to='/autumn/answer' activeClassName="activeLink" >
